...
const (
	...
	EventAuthValidated             SessionEventType = "auth_validated"
	EventAuthRejected              SessionEventType = "auth_rejected"
	EventAuthPolicyDenied          SessionEventType = "auth_policy_denied"
